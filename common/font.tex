...
\newcommand{\AdobeSong}{\fontspec{Adobe Song Std}}
\newcommand{\AdobeFangSong}{\fontspec{Adobe Fangsong Std}}
\newcommand{\AdobeHeiti}{\fontspec{Adobe Heiti Std}}
\newcommand{\AdobeKaiti}{\fontspec{Adobe Kaiti Std}}
...
\setCJKmainfont[BoldFont=Adobe Heiti Std,ItalicFont=Adobe Kaiti Std,SmallCapsFont=*]{Adobe Fangsong Std} 
% 无衬线字体。黑体本质上是无衬线字体。黑体加粗或者加斜都保持原状不变。
\setCJKsansfont[BoldFont=Adobe Heiti Std,ItalicFont=Adobe Heiti Std,SmallCapsFont=*]{Adobe Heiti Std}
% 等宽字体。中文本质上是等宽字体，默认继续使用仿宋。粗体用黑体代替，斜体用楷体代替。
\setCJKmonofont[BoldFont=Adobe Heiti Std,ItalicFont=Adobe Kaiti Std,SmallCapsFont=*]{Adobe Fangsong Std}